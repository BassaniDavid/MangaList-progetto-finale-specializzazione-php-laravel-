...
<div class="jumbotron p-5 mb-4 rounded-3">
    <div class="container py-5">
        <h2 class="fs-2 mb-5 text-center">benvenuto nella sezione dei generi</h2>
        <h3 class="mb-5 text-center"><a href="{{ route('genre.create') }}" class="btn btn-lg btn-outline-info">aggiungi nuovo genere</a></h3>

        <div class="card p-4">
            <table class="table table-bordered m-0">
                <tr>
                    <th class="bg-warning-subtle">genere</th>
                    <th class="bg-warning-subtle">descrizione</th>
                    ...
                    <tr>
                        <td><strong>{{ $genre->genere }}</strong></td>
